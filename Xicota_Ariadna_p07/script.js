$( document ).ready(function() {
	...
	function render(){
		...
		ctx.stroke();
		var img1=document.getElementById("eq1");
		var img2=document.getElementById("eq2");
		ctx.drawImage(img1,canvas.width*1/4-10,30,30,35);
		ctx.drawImage(img2,canvas.width*3/4-10,30,30,35);
		ctx.fillStyle="white";
		ctx.fillText("Equip A", canvas.width*1/4-15,80);
		ctx.fillText("Equip B", canvas.width*3/4-15,80);
		actualitzamarcador(ctx);
		pala_L.render(ctx);
		pala_R.render(ctx);
		bola.render(ctx);
